...
export default function Checkout() {
  ...
  useEffect(() => {
    if (localStorage.getItem("user")) {
      ...
      fetch(`${process.env.NEXT_PUBLIC_HOST_URL}/api/getUser`, {
        method: "POST",
  ...
  const initiatePayment = () => {
    ...
    fetch(`${process.env.NEXT_PUBLIC_HOST_URL}/api/verfiycart`, {
      method: "POST",
  ...
  const createNewOrder = (orderId) => {
    fetch(`${process.env.NEXT_PUBLIC_HOST_URL}/api/createorder`, {
      method: "POST",
      body: JSON.stringify({
        orderId,
        name,
